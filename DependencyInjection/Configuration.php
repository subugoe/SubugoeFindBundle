...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ...
            ->end()
            ->arrayNode('mets_fields')
                ->prototype('scalar')->end()
            ->end()
                ->arrayNode('anchor_fields')
                ->prototype('scalar')->end()
            ->end()
            ->arrayNode('toc_fields')
                ->prototype('scalar')->end()
            ->end()
            ->arrayNode('default_fields')
                ->prototype('scalar')->end()
            ->end()
                ->arrayNode('structure_fields')
                ->prototype('scalar')->end()
            ->end()
                ->arrayNode('bibliographic_fields')
                ->prototype('scalar')->end()
            ->end()
            ->arrayNode('volumes_fields')
                ->prototype('scalar')->end()
            ->end()
            ->arrayNode('volumes_children_fields')
                ->prototype('scalar')->end()
            ->end()
                ->arrayNode('details_fields')
                ->prototype('scalar')->end()
            ->end()
